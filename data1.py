...
for key, value in tokenizer.word_counts.items():
    ...
    X_train = pad_sequencse(X_train, maxlen = max_len)
    X_test = pad_sequencse(X_test, maxlen = max_len)
    ...
    mc = ModelCheckpoint("naver_movie.h5", monitor="val_acc", mode="max", verbose=1, save_best_onle=True)
